      ...
      <div className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="grid lg:grid-cols-2 gap-10 p-10 items-center">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-600 leading-loose">
                تعلم كيفية إدراج الجداول والصور داخل مستند Word بطريقة منظمة واحترافية.
              </p>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-3">
            ...
            <p className="text-gray-600">• إدراج الجداول</p>
            <p className="text-gray-600">• إدراج الصور</p>
            <p className="text-gray-600">• تنسيق العناصر داخل المستند</p>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
              ...
              <p className="text-gray-600 leading-loose">
                من قائمة Insert يمكنك إضافة جداول لتنظيم البيانات أو صور لتوضيح المحتوى وجعل المستند أكثر احترافية.
              </p>
